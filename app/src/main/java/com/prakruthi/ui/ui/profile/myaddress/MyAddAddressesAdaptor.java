...
//    LayoutInflater inflater = getLayoutInflater(); // Use the appropriate inflater method for your context


//    public MyAddressesAdaptor(List<String> data, LayoutInflater inflater) {
//        this.data = data;
////        this.inflater = inflater;
//    }


//    private LayoutInflater inflater; // Add this field
...
//public MyAddAddressesAdaptor(ArrayList<Address_BottomSheet_Recycler_Adaptor_Model> addressModelsList, DeleteDeliveryAddressDetails.OnDeleteDeliveryAddressApiHits deleteDeliveryAddressListner) {
