...
//    public static int tax;
    ...
    // Constructor
    public CartModal(int id, int productId, int quantity, String name, String description, String customerPrice, String actualPrice, String dealerPrice, String martPrice, String attachment) {
        this.id = id;
